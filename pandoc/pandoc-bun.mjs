...
if (!Object.hasOwn(options, fromArg)) {
  console.log(`\nError! There is no data for ${from}! Script execution was terminated!\n`)
  shell.exit(99)
}

// tikrina, ar egzistuoja tikslinio formato duomenys  
if (!Object.hasOwn(options, toArg)) {
  console.log(`\nError! There is no data for ${to}! Script execution was terminated!\n`)
  shell.exit(99)
}
...
// jeigu komanda įvykdyta nesėkmingai, spausdina išėjimo kodą
if (code !== 0) {
  console.log(code)
}
